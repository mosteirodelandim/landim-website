...
const images = [originPic1, originPic2];
          ...
          <section className="wrapper style5">
            <div className="inner">
              ...
              <section>
                ...
                <div className="box alt">
                  <div className="row gtr-50 gtr-uniform">
                    <div className="col-12"><span className="image fit"><img src={originPic5} alt="" /></span></div>
                    <div className="col-4"><span className="image fit"><img src={originPic5} alt="" /></span></div>
                    <div className="col-4"><span className="image fit"><img src={originPic5} alt="" /></span></div>
                    <div className="col-4"><p className="image fit">asdas</p></div>
                    <div className="col-4"><span className="image fit"><img src={originPic5} alt="" /></span></div>
                    <div className="col-4"><span className="image fit"><img src={originPic5} alt="" /></span></div>
                    <div className="col-4"><span className="image fit"><img src={originPic5} alt="" /></span></div>
                    <div className="col-4"><span className="image fit"><img src={originPic5} alt="" /></span></div>
